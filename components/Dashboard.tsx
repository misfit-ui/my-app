...
const Dashboard: React.FC<DashboardProps> = ({ data, totalBankroll, onAddSession }) => {
  ...
  return (
    <div className="p-4 space-y-6">
      {/* Total Bankroll Card */}
      <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-3xl p-6 shadow-xl shadow-indigo-900/40 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-4">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-3 flex-1 flex flex-col gap-1 border border-white/5">
      ...
      <div className="grid grid-cols-1 gap-3">
        <button 
          ...
          className="group flex items-center justify-between p-4 bg-slate-900 border border-slate-800 rounded-2xl active:scale-[0.98] transition-all shadow-sm hover:border-indigo-500/30"
        >
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2">
          {lastSessions.map((session) => {
            ...
            return (
              <div key={session.id} className="bg-slate-900 border border-slate-800/50 p-4 rounded-2xl flex justify-between items-center shadow-sm hover:bg-slate-800/30 transition-colors">
          ...
          {lastSessions.length === 0 && (
            <div className="text-center py-12 bg-slate-900/30 rounded-3xl border border-dashed border-slate-800 text-slate-600 text-xs font-medium italic">
